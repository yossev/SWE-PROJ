...
let QuestionDto = (() => {
    ...
    return _a = class QuestionDto {
            constructor() {
                this.question = __runInitializers(this, _question_initializers, void 0); // The question text
                this.options = (__runInitializers(this, _question_extraInitializers), __runInitializers(this, _options_initializers, void 0)); // Array of possible answers (e.g., for MCQs)
                this.correctAnswer = (__runInitializers(this, _options_extraInitializers), __runInitializers(this, _correctAnswer_initializers, void 0)); // The correct answer for the question
                this.difficultyLevel = (__runInitializers(this, _correctAnswer_extraInitializers), __runInitializers(this, _difficultyLevel_initializers, void 0)); // Difficulty level of the question
                __runInitializers(this, _difficultyLevel_extraInitializers);
            }
        },
        (() => {
            ...
            _difficultyLevel_decorators = [(0, class_validator_1.IsEnum)(DifficultyLevel)];
