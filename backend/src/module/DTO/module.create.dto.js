...
let CreateModuleDto = (() => {
    ...
    return _a = class CreateModuleDto {
            constructor() {
        ...
        (() => {
            ...
            _course_id_decorators = [(0, class_validator_1.IsNotEmpty)()];
            _title_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.Length)(1, 100)];
            _content_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.Length)(1, 5000)];
            _resources_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)(), (0, class_validator_1.IsString)({ each: true })];
            _created_at_decorators = [(0, class_validator_1.IsDate)()];
