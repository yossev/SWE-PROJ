...
let CreateQuizDto = (() => {
    ...
    return _a = class CreateQuizDto {
        ...
        (() => {
            ...
            _questionType_decorators = [(0, class_validator_1.IsEnum)(module_question_dto_1.QuestionType)];
            _numberOfQuestions_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(1)];
            _questions_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.ValidateNested)({ each: true }), (0, class_transformer_1.Type)(() => module_question_dto_2.QuestionDto)];
