...
exports.UpdateQuestionBankDto = exports.QuestionType = exports.DifficultyLevel = void 0;
...
let UpdateQuestionBankDto = (() => {
    ...
    return _a = class UpdateQuestionBankDto {
            constructor() {
        ...
        (() => {
            ...
            _question_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Length)(1, 100)];
            _options_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)(), (0, class_validator_1.IsString)({ each: true })];
            _correct_answer_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _explanation_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Length)(1, 1000)];
            _difficulty_level_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(DifficultyLevel)];
            _module_id_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsMongoId)()];
            _question_type_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(QuestionType)];
