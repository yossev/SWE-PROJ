...
export class QuestionBankController {
    ...
    @Post()
    async createQuestionBank(@Body() questionBankData: CreateQuestionBankDto): Promise<QuestionBank> {
        const newQuestionBank = await this.questionBankService.create(questionBankData);
