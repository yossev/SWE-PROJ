...
let ForumService = (() => {
    ...
    var ForumService = _classThis = class {
        ...
        deleteForum(forumId, instructorId) {
            return __awaiter(this, void 0, void 0, function* () {
                const forum = this.forumModel.findById(new mongoose_1.Types.ObjectId(forumId)).exec();
                const creatorIdString = ((yield forum).createdBy).toString();
                if (creatorIdString === instructorId) {
                    (yield forum).active = false;
                    return (yield forum).save();
                }
                else {
    ...
    __setFunctionName(_classThis, "ForumService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ForumService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ForumService = _classThis;
})();
