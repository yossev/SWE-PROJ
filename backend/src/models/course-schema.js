...
let Course = (() => {
    ...
    var Course = _classThis = class {
        constructor() {
            ...
            this.instructor = (__runInitializers(this, _created_at_extraInitializers), __runInitializers(this, _instructor_initializers, void 0));
    ...
    (() => {
        ...
        _difficulty_level_decorators = [(0, mongoose_1.Prop)({
                type: String,
                required: true,
